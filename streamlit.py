...
Original file is located at
    https://colab.research.google.com/drive/17Nosc5PHfqu1d7HnzqSdQ5c9LjbcXxTZ
"""
...
#การออกแบบส่วนแสดงผลแถบด่้านข้าง (Sidebar) ที่จะใช้บน Streamlit สำหรับกรอกข้อมูลนำเข้า
...
if prediction == 1:
  ...
  * **Expected ROI:** ค่าใช้จ่ายในการโทร+ส่วนลด คุ้มค่ากว่าการหาลูกค้าใหม่
  ...
  st.error(f"✅ มีความเสี่ยงน้อยโดยที่ลูกค้ารายนี้มแนวโน้มใช้งานต่อ (โดยมีความเสี่ยงเพียง {probability:.1%})")
